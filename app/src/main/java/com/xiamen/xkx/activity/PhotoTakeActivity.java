...
public class PhotoTakeActivity extends AppCompatActivity implements OnClickListener {
    ...
    private void showDialog(String mess) {
        new AlertDialog.Builder(PhotoTakeActivity.this).setTitle("Message").setMessage(mess).setNegativeButton("确定", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {

                Intent intent = new Intent();
                intent.setClass(PhotoTakeActivity.this, PhotoScanningActivity.class);
